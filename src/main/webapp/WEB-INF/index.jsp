...
<nav class="navbar navbar-light bg-light sticky-top">
  <div class="container-fluid">
    <a class="navbar-brand fs-4" href="/index">Lavie</a>
    <!-- Light -->
...
<div class="container border p-2 " style="margin-bottom:20px ">
  ...
  <div class="row row-cols-2 row-cols-lg-5 g-0 g-lg-3">
    <c:forEach var="p" items="${listP}" begin="4" end="8">
      <div class="col">
        <div class="p-3 border ">
          <a class="card-line bg-image hover-overlay ripple" data-mdb-ripple-color="light" href="#" style="color: #5e5e5e">
            <img
                    src="${p.image}"
            ...
            />
            <div>${p.name}</div>
            <div style="color: red;text-align: right;padding-top: 10px;vertical-align: bottom">${p.price}</div>
          </a>
        </div>
      </div>
    </c:forEach>
...
<div class="container border p-2 " style="margin-bottom:20px ">
  ...
  <div class="row row-cols-2 row-cols-lg-5 g-0 g-lg-3">
    <c:forEach var="p" items="${listP}" begin="10" end="14">
      <div class="col">
        <div class="p-3 border ">
          <a class="card-line bg-image hover-overlay ripple" data-mdb-ripple-color="light" href="#" style="color: #5e5e5e">
            <img
